...
contract StarNotary is ERC721 {
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        if(bytes(tokenIdToStarInfo[_tokenId].name).length > 0)
            tokenName=tokenIdToStarInfo[_tokenId].name;
        return tokenName;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((address1 == msg.sender || address2 == msg.sender), "You can not exchange a star you don't own!");    
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "You can not transfer a star you don't own!");
